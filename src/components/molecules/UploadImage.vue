<template>
  <div class="flex flex-col items-center gap-5">
    <label for="fileInput" class="rounded-lg text-xs py-2 px-4 cursor-pointer bg-gray-100 hover:bg-gray-200 border border-transparent hover:border-gray-300 transition-all duration-300">
      <img v-if="!isLoad" :src=" imageUrl ? imageUrl : currentImage" :alt="currentImage" class="size-20 rounded-full mx-auto mb-1 object-cover" />
      <div v-if="isLoad" class="bg-gray-200 animate-pulse size-20 rounded-full mx-auto mb-1"></div>
